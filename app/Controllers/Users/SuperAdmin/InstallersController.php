...
use App\Models\Users\SuperAdmin\InstallerTechDataModel;
use App\Models\Users\SuperAdmin\InstallerTechTeamAreaModel;
...
class InstallersController extends BaseController
{
    ...
    {
        return $this->render('super_admin.installers.create', [
            'title' => 'Add Installer',
        ]);
    }
    ...
    public function techData(): string
    {
        ...
        return $this->render('super_admin.installers.tech-data', [
            'title' => 'Tech Data',
            'rows' => $rows,
        ]);
    }
    ...
    public function techTeamArea(): string
    {
        ...
        return $this->render('super_admin.installers.tech-team-area', [
