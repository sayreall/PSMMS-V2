...
<body class="bg-slate-50 text-slate-900 min-h-screen flex items-center justify-center p-6">
    <div class="max-w-lg text-center">
        <p class="text-sm font-semibold text-teal-600">500</p>
        <h1 class="text-3xl font-bold mt-2">Something went wrong</h1>
        <p class="mt-3 text-slate-600">We hit an unexpected error. Try again or contact support.</p>
        <div class="mt-6">
