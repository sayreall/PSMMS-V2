            ...
            <div class="px-1 mb-3">
                <div class="relative">
                    <input type="text" placeholder="Search"
                           class="w-full pl-9 pr-3 py-2 text-xs border border-slate-200 rounded-lg bg-white text-slate-700 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-primary-500/20">
