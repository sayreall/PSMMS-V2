...
if ($isSuperAdminSidebar) {
    ...
    $menuItems[] = ['key' => 'daily_flow_thru', 'label' => 'Daily Flow Thru', 'url' => $headManagerDashboardUrl . '?section=daily-flow-thru', 'icon' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 7h11m0 0l-3-3m3 3l-3 3M20 17H9m0 0l3-3m-3 3l3 3"/>'];
    $menuItems[] = ['key' => 'partners_report', 'label' => 'Partners Report', 'url' => $headManagerDashboardUrl . '?section=partners-report', 'icon' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M9 20H4v-2a3 3 0 015.356-1.857M12 12a4 4 0 100-8 4 4 0 000 8z"/>'];
